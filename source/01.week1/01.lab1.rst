...
.. admonition:: When You Are Done
    ...
    **Note:** 
    ...
    - You can run the ``done.sh`` script at any point when you are working on the assignment
      and the content of the generated ``lab01.txt`` may be helpful in addition to the check scripts in
      each question.

    - However, you must run it just prior to submitting the generated ``lab01.txt`` file
...
.. admonition:: Check and record your work:
...
.. admonition:: Change the index.html file
